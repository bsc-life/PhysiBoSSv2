...
void setup_microenvironment( void )
{
	...
	// setting the homogeneous initial condition for every voxel
	default_microenvironment_options.initial_condition_vector = condition_vector;
	// setting the Dirichlet boundaries OFF for the drugs
	default_microenvironment_options.Dirichlet_activation_vector = activation_vector;
